...
public abstract class CalendarPager extends ViewPager {
    ...
    public CalendarPager(Context context, AttributeSet attrs) {
        ...
        Attrs.selectCircleRadius = ta.getDimension(R.styleable.NCalendar_selectCircleRadius, Utils.dp2px(context, 10));
        ...
        Attrs.padding = ta.getDimension(R.styleable.NCalendar_padding, (int) Utils.dp2px(context, 120));
