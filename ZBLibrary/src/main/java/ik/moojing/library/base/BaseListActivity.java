...
package ik.moojing.library.base;
...
import ik.moojing.library.R;
import ik.moojing.library.interfaces.AdapterCallBack;
import ik.moojing.library.interfaces.CacheCallBack;
import ik.moojing.library.interfaces.OnStopLoadListener;
import ik.moojing.library.manager.CacheManager;
import ik.moojing.library.util.Log;
import ik.moojing.library.util.SettingUtil;
import ik.moojing.library.util.StringUtil;
...
public abstract class BaseListActivity<T, LV extends AbsListView, A extends ListAdapter>
	...
	public void setAdapter(A adapter) {
		if (adapter != null && adapter instanceof ik.moojing.library.base.BaseAdapter) {
			((ik.moojing.library.base.BaseAdapter) adapter).setOnItemClickListener(this);
			((ik.moojing.library.base.BaseAdapter) adapter).setOnItemLongClickListener(this);
		}
