...
import com.ik.moojing.utils.FucUtil;
    ...
    public void onClickView(View view) {
        switch (view.getId()) {
            case R.id.ll_weather:
                ...
                break;
            case R.id.ll_date_time://时间、日期
                startActivity(new Intent(MainActivity.this, ClendarActivity.class));
                break;
        }
    }
